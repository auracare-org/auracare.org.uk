...
<div class="tone-demo">
	<div class="tier" role="radiogroup" aria-label="How blunt should Twin be?">
...
<style>
	/* Sits on the dark persona panel, so the control is styled for a dark
	   surface; the phone carries its own light screen. */
	.tier-label {
		display: block;
		font-size: 0.78rem;
		font-weight: 600;
