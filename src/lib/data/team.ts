...
export const team: Record<string, TeamMember> = {
	...
	'julius-chu': {
		...
		role: 'CPO',
		bio: 'Computer science at NYU. Leads product: the design system, the patient experience, and how the stages of the pipeline fit together.',
	...
	'ahnaf-kabir': {
		...
		role: 'CISO',
		bio: 'Former software lead at Slate and previously co-founder of a medtech company bringing aural health to the home. Manages security operations, technical infrastructure and backend engineering.',
