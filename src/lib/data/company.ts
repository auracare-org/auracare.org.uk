...
/* Six steps, laid out as a snake with arrows: 01 to 03 across the top, down
   into 04, back across the bottom to 06, and a return arrow closing the loop. */
export const CARE_LOOP: CareLoopStep[] = [
	...
	},
	{
		...
		body: 'The shared history, acute vitals and the live conversation together; it asks only what’s worth asking.'
	},
	{
		actor: 'auracare',
		title: 'The clinician decides',
		body: 'Ranked differentials and guideline-aligned next steps; the judgement stays with the clinician, and the notes write themselves.'
	},
	{
		actor: 'auratwin',
